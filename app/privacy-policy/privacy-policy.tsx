        ...
        <div className="min-h-screen bg-[#E6F3FF] py-12 sm:py-16 lg:py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-primary mb-4">Privacy Policy</h1>
                    ...
                    <div className="p-8 sm:p-12">
                        <div className="prose prose-lg max-w-none">
                            <div className="space-y-8">
                                ...
                                {/* Your Rights */}
                                <section>
                                    <h2 className="text-2xl font-bold text-primary mb-4">6. Your Rights and Choices</h2>
                                    <p className="text-secondary leading-relaxed mb-4">
                                ...
                                <section>
                                    ...
                                    <div className="border-2 border-white rounded-lg p-6">
                                        <div className="space-y-2">
                                            <p className="text-secondary"><strong>Email:</strong> privacy@empireblue.com</p>
