...
const HealthImpactSection = () => {
  const impacts = [
    ...
    },
    {
      ...
      iconColor: "#9333EA",
      stat: "3.5B",
      position: "top-[50%] left-[5%] -translate-y-1/2",
    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#FF4D6B]/10 to-[#FF4D6B]/5 px-5 py-2.5 rounded-full mb-6">
            <div className="w-2 h-2 bg-[#FF4D6B] rounded-full animate-pulse"></div>
            <span className="text-[#FF4D6B] text-sm font-medium">Health Impact</span>
          </div>
          <h2 className="text-[#1D1D42] text-4xl md:text-5xl font-bold mb-6">
            Impact of
            <span className="relative mx-3">
              <span className="relative z-10 bg-gradient-to-r from-[#FF4D6B] to-[#4284FF] text-transparent bg-clip-text">Contaminated</span>
              <div className="absolute -bottom-2 left-0 w-full h-3 bg-[#FF4D6B]/10 rounded-full -z-0"></div>
            </span>
            Water
          </h2>
        </div>
        ...
        <div className="relative mx-auto" style={{ width: '1000px', height: '700px' }}>
          ...
          {impacts.map((impact, index) => (
            <div
              key={index}
              className={`absolute ${impact.position} w-[280px] transition-all duration-500 hover:scale-105`}
            >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-baseline gap-2 mb-2">
                      <h3 className="text-[#1D1D42] text-xl font-bold">
                        {impact.stat}
                      </h3>
                      <div className="h-px w-8 bg-gradient-to-r from-[#FF4D6B] to-transparent"></div>
                    </div>
                    <h4 className="text-[#1D1D42] text-base font-medium mb-1">
                      {impact.title}
                    </h4>
