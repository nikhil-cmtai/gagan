      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <Link href="/" className="flex flex-col items-start group">
            <span className="text-[#4284FF] text-2xl font-bold group-hover:text-[#2563EB] transition-colors">
              Empire Blue
            </span>
            <span className="text-gray-600 text-sm mt-0.5 group-hover:text-[#4284FF] transition-colors">
          ...
          <button className="md:hidden group">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-600 group-hover:text-[#4284FF] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
