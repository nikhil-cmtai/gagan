          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <Link href="tel:+1234567890" className="text-gray-600 hover:text-[#1D22BF] transition-colors">
                  (123) 456-7890
                </Link>
              </li>
              <li className="flex items-center gap-3">
                ...
                <Link href="mailto:info@imperialwater.com" className="text-gray-600 hover:text-[#1D22BF] transition-colors">
                  info@imperialwater.com
                </Link>
              </li>
            </ul>
          </div>
